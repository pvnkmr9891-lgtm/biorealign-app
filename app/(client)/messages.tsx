...
import { useMessages, useSendMessage, useMarkMessagesRead, useClientCoachInfo, uploadChatAttachment } from '@/hooks/useCoach';
...
export default function ClientMessagingScreen() {
  ...
  const handleAttach = async () => {
    ...
    try {
      ...
      setText('');
      await sendMessage({ coachId, clientId, receiverId: coachId, body: caption, attachmentPath: path });
      setTimeout(() => scrollRef.current?.scrollToEnd({ animated: true }), 100);
    } catch (e: any) {
