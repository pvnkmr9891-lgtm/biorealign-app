// 18-day rotating nutrition plan — Future Body Reset, Age 6–8, Non-Vegetarian, Hard Intensity
// 7 meals/day — Pre-Activity (order 3) + Post-Activity Recovery (order 5).
// Strings taken verbatim from Excel source file.

import type { NutritionDay } from './index';

export const FBR_AGE6TO8_NONVEG_HARD: NutritionDay[] = [
  {
    day: 1,
    meals: [
      { order: 1, label: 'Breakfast',     name: 'Idli (3-4 pcs) with sambar and chutney + 1 glass milk with almonds' },
      { order: 2, label: 'Mid-Morning',   name: '1 boiled egg' },
      { order: 3, label: 'Pre-Activity',  name: 'Small banana or 2 dates' },
      { order: 4, label: 'Lunch',         name: 'Rice (1-1.5 cups) + chicken curry (moderate portion) + bottle gourd curry + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Milk with banana' },
      { order: 6, label: 'Evening Snack', name: 'Roasted chana (small handful)' },
      { order: 7, label: 'Dinner',        name: 'Roti (2) + egg curry + cucumber salad' },
    ],
  },
  {
    day: 2,
    meals: [
      ...
      { order: 4, label: 'Lunch',         name: 'Roti (2) + dal (1 cup) + mixed vegetable + curd (1/2 cup)' },
      ...
      { order: 7, label: 'Dinner',        name: 'Rice (1 cup) + fish curry (moderate portion) + bhindi sabzi' },
    ],
  },
  {
    day: 3,
    meals: [
      ...
      { order: 4, label: 'Lunch',         name: 'Rice (1.5 cups) + chicken curry (moderate portion) + cabbage poriyal + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Milk with banana' },
      { order: 6, label: 'Evening Snack', name: '1 apple' },
      { order: 7, label: 'Dinner',        name: 'Roti (2) + paneer curry + carrot-beans sabzi' },
    ],
  },
  {
    day: 4,
    meals: [
      ...
      { order: 4, label: 'Lunch',         name: 'Roti (2) + dal (1 cup) + onion-tomato salad + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Banana with peanut butter' },
      { order: 6, label: 'Evening Snack', name: 'Vegetable cutlet (small)' },
      { order: 7, label: 'Dinner',        name: 'Rice (1 cup) + fish curry (moderate portion) + lauki sabzi' },
    ],
  },
  {
    day: 5,
    meals: [
      ...
      { order: 4, label: 'Lunch',         name: 'Rice (1.5 cups) + chicken curry (moderate portion) + palak sabzi + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Small piece grilled chicken with fruit' },
      { order: 6, label: 'Evening Snack', name: 'Roasted peanuts (small handful)' },
      { order: 7, label: 'Dinner',        name: 'Roti (2) + dal + mixed vegetable curry' },
    ],
  },
  {
    day: 6,
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '1 boiled egg' },
      { order: 3, label: 'Pre-Activity',  name: 'Dates (2-3)' },
      { order: 4, label: 'Lunch',         name: 'Roti (2) + dal (1 cup) + beetroot poriyal + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Milk with banana' },
      { order: 6, label: 'Evening Snack', name: 'Vegetable soup (small bowl)' },
      { order: 7, label: 'Dinner',        name: 'Rice (1 cup) + chicken curry (moderate portion) + cauliflower sabzi' },
    ],
  },
  {
    day: 7,
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '2 boiled eggs' },
      { order: 3, label: 'Pre-Activity',  name: 'Small banana' },
      { order: 4, label: 'Lunch',         name: 'Rice (1.5 cups) + fish curry (moderate portion) + ridge gourd curry + curd (1/2 cup)' },
  ...
  },
  {
    ...
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '1 boiled egg' },
      { order: 3, label: 'Pre-Activity',  name: 'Dates with milk' },
      { order: 4, label: 'Lunch',         name: 'Roti (2) + chicken curry (moderate portion) + mixed vegetable + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Small piece grilled chicken with fruit' },
      { order: 6, label: 'Evening Snack', name: 'Roasted chana (small handful)' },
  ...
  },
  {
    ...
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '2 boiled eggs' },
      { order: 3, label: 'Pre-Activity',  name: 'Dates (2-3)' },
      { order: 4, label: 'Lunch',         name: 'Roti (2) + fish curry (moderate portion) + bhindi sabzi + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Banana with peanut butter' },
      { order: 6, label: 'Evening Snack', name: 'Vegetable cutlet (small)' },
      { order: 7, label: 'Dinner',        name: 'Rice (1 cup) + chicken curry (moderate portion) + cabbage sabzi' },
    ],
  },
  {
    day: 11,
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '1 boiled egg' },
      { order: 3, label: 'Pre-Activity',  name: 'Small banana' },
      { order: 4, label: 'Lunch',         name: 'Rice (1.5 cups) + dal (1 cup) + beans poriyal + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Small piece grilled chicken with fruit' },
  ...
  },
  {
    ...
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '1 boiled egg' },
      { order: 3, label: 'Pre-Activity',  name: 'Dates with milk' },
      { order: 4, label: 'Lunch',         name: 'Roti (2) + chicken curry (moderate portion) + cucumber-tomato salad + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Milk with banana' },
      { order: 6, label: 'Evening Snack', name: 'Roasted peanuts (small handful)' },
  ...
  },
  {
    ...
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '2 boiled eggs' },
      { order: 3, label: 'Pre-Activity',  name: 'Small banana' },
      { order: 4, label: 'Lunch',         name: 'Rice (1.5 cups) + fish curry (moderate portion) + cabbage poriyal + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Banana with almonds' },
      { order: 6, label: 'Evening Snack', name: 'Murmura chaat, light' },
      { order: 7, label: 'Dinner',        name: 'Roti (2) + dal + mixed vegetable curry' },
    ],
  },
  {
    ...
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '1 boiled egg' },
      { order: 3, label: 'Pre-Activity',  name: 'Dates (2-3)' },
      { order: 4, label: 'Lunch',         name: 'Roti (2) + dal (1 cup) + beetroot sabzi + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Small piece grilled chicken with fruit' },
      { order: 6, label: 'Evening Snack', name: '1 banana' },
      { order: 7, label: 'Dinner',        name: 'Rice (1 cup) + chicken curry (moderate portion) + carrot-beans sabzi' },
    ],
  },
  {
    day: 15,
    meals: [
      ...
      { order: 5, label: 'Post-Activity', name: 'Milk with banana' },
      { order: 6, label: 'Evening Snack', name: 'Vegetable soup (small bowl)' },
      { order: 7, label: 'Dinner',        name: 'Roti (2) + fish curry (moderate portion) + onion-tomato salad' },
    ],
  },
  {
    day: 16,
  ...
  },
  {
    ...
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '1 boiled egg' },
      { order: 3, label: 'Pre-Activity',  name: 'Small banana' },
      { order: 4, label: 'Lunch',         name: 'Rice (1.5 cups) + dal (1 cup) + palak sabzi + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Small piece grilled chicken with fruit' },
      { order: 6, label: 'Evening Snack', name: 'Vegetable cutlet (small)' },
      { order: 7, label: 'Dinner',        name: 'Roti (2) + egg curry + cucumber salad' },
    ],
  },
  {
    ...
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '2 boiled eggs' },
      { order: 3, label: 'Pre-Activity',  name: 'Dates (2-3)' },
      { order: 4, label: 'Lunch',         name: 'Roti (2) + fish curry (moderate portion) + cabbage sabzi + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Milk with banana' },
      { order: 6, label: 'Evening Snack', name: '1 orange' },
      { order: 7, label: 'Dinner',        name: 'Rice (1 cup) + chicken curry (moderate portion) + cauliflower sabzi' },
    ],
