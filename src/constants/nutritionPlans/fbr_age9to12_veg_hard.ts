// 18-day rotating nutrition plan — Future Body Reset, Age 9–12, Vegetarian (Lacto-Ovo), Hard Intensity
...
export const FBR_AGE9TO12_VEG_HARD: NutritionDay[] = [
  {
    day: 1,
    meals: [
      ...
      { order: 4, label: 'Lunch',         name: 'Rice (2 cups) + moong dal (1 cup) + bottle gourd curry + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Paneer cubes or milk with banana' },
      { order: 6, label: 'Evening Snack', name: 'Roasted chana (handful)' },
      { order: 7, label: 'Dinner',        name: 'Roti (2-3) + paneer bhurji + cucumber salad' },
    ],
  },
  {
    day: 2,
    meals: [
      ...
      { order: 4, label: 'Lunch',         name: 'Roti (2-3) + rajma curry (1 cup) + mixed vegetable + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Milk with banana' },
      { order: 6, label: 'Evening Snack', name: 'Murmura chaat' },
      { order: 7, label: 'Dinner',        name: 'Rice (1.5-2 cups) + dal tadka + bhindi sabzi' },
    ],
  },
  {
    day: 3,
    meals: [
      ...
      { order: 4, label: 'Lunch',         name: 'Rice (2 cups) + sambar + cabbage poriyal + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Paneer cubes with fruit' },
      { order: 6, label: 'Evening Snack', name: '1 orange' },
      { order: 7, label: 'Dinner',        name: 'Roti (2-3) + egg curry + carrot-beans sabzi' },
    ],
  },
  {
    day: 4,
    meals: [
      ...
      { order: 4, label: 'Lunch',         name: 'Roti (2-3) + chole (1 cup) + onion-tomato salad + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Banana with peanut butter' },
      { order: 6, label: 'Evening Snack', name: 'Vegetable cutlet' },
      { order: 7, label: 'Dinner',        name: 'Rice (1.5-2 cups) + paneer curry + lauki sabzi' },
    ],
  },
  {
    day: 5,
    meals: [
      ...
      { order: 4, label: 'Lunch',         name: 'Rice (2 cups) + dal makhani (1 cup) + palak sabzi + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Paneer cubes with fruit' },
      { order: 6, label: 'Evening Snack', name: 'Roasted peanuts (handful)' },
      { order: 7, label: 'Dinner',        name: 'Roti (2-3) + mixed vegetable curry + dal' },
    ],
  },
  {
    day: 6,
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '2 boiled eggs' },
      { order: 3, label: 'Pre-Activity',  name: 'Dates (3-4)' },
      { order: 4, label: 'Lunch',         name: 'Roti (2-3) + lobia curry + beetroot poriyal + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Milk with banana' },
      { order: 6, label: 'Evening Snack', name: 'Vegetable soup (bowl)' },
      { order: 7, label: 'Dinner',        name: 'Rice (1.5-2 cups) + sambar + cauliflower sabzi' },
    ],
  },
  {
    day: 7,
  ...
  },
  {
    ...
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '2 boiled eggs' },
      { order: 3, label: 'Pre-Activity',  name: 'Dates with milk' },
      { order: 4, label: 'Lunch',         name: 'Roti (2-3) + matar paneer + mixed vegetable + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Paneer cubes with fruit' },
      { order: 6, label: 'Evening Snack', name: 'Roasted chana (handful)' },
  ...
  },
  {
    ...
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '2 boiled eggs' },
      { order: 3, label: 'Pre-Activity',  name: 'Dates (3-4)' },
      { order: 4, label: 'Lunch',         name: 'Roti (2-3) + dal makhani + bhindi sabzi + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Banana with peanut butter' },
      { order: 6, label: 'Evening Snack', name: 'Vegetable cutlet' },
      { order: 7, label: 'Dinner',        name: 'Rice (1.5-2 cups) + rajma curry + cabbage sabzi' },
    ],
  },
  {
    day: 11,
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '2 boiled eggs' },
      { order: 3, label: 'Pre-Activity',  name: 'Banana' },
      { order: 4, label: 'Lunch',         name: 'Rice (2 cups) + sambar + beans poriyal + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Paneer cubes with fruit' },
  ...
  },
  {
    ...
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '2 boiled eggs' },
      { order: 3, label: 'Pre-Activity',  name: 'Dates with milk' },
      { order: 4, label: 'Lunch',         name: 'Roti (2-3) + chole + cucumber-tomato salad + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Milk with banana' },
      { order: 6, label: 'Evening Snack', name: 'Roasted peanuts (handful)' },
  ...
  },
  {
    ...
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '2 boiled eggs' },
      { order: 3, label: 'Pre-Activity',  name: 'Banana' },
      { order: 4, label: 'Lunch',         name: 'Rice (2 cups) + moong dal + cabbage poriyal + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Banana with almonds' },
      { order: 6, label: 'Evening Snack', name: 'Murmura chaat' },
      { order: 7, label: 'Dinner',        name: 'Roti (2-3) + mixed vegetable curry + dal' },
    ],
  },
  {
    ...
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '2 boiled eggs' },
      { order: 3, label: 'Pre-Activity',  name: 'Dates (3-4)' },
      { order: 4, label: 'Lunch',         name: 'Roti (2-3) + lobia curry + beetroot sabzi + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Paneer cubes with fruit' },
      { order: 6, label: 'Evening Snack', name: '1 banana' },
      { order: 7, label: 'Dinner',        name: 'Rice (1.5-2 cups) + sambar + carrot-beans sabzi' },
    ],
  },
  {
    day: 15,
    meals: [
      ...
      { order: 5, label: 'Post-Activity', name: 'Milk with banana' },
      { order: 6, label: 'Evening Snack', name: 'Vegetable soup (bowl)' },
      { order: 7, label: 'Dinner',        name: 'Roti (2-3) + egg curry + onion-tomato salad' },
    ],
  },
  {
    day: 16,
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '2 boiled eggs' },
      { order: 3, label: 'Pre-Activity',  name: 'Dates with milk' },
      { order: 4, label: 'Lunch',         name: 'Roti (2-3) + rajma curry + mixed vegetable + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Banana with almonds' },
      { order: 6, label: 'Evening Snack', name: 'Roasted chana (handful)' },
  ...
  },
  {
    ...
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '2 boiled eggs' },
      { order: 3, label: 'Pre-Activity',  name: 'Banana' },
      { order: 4, label: 'Lunch',         name: 'Rice (2 cups) + dal makhani + palak sabzi + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Paneer cubes with fruit' },
      { order: 6, label: 'Evening Snack', name: 'Vegetable cutlet' },
      { order: 7, label: 'Dinner',        name: 'Roti (2-3) + paneer bhurji + cucumber salad' },
    ],
  },
  {
    ...
    meals: [
      ...
      { order: 2, label: 'Mid-Morning',   name: '2 boiled eggs' },
      { order: 3, label: 'Pre-Activity',  name: 'Dates (3-4)' },
      { order: 4, label: 'Lunch',         name: 'Roti (2-3) + chole + cabbage sabzi + curd (1/2 cup)' },
      { order: 5, label: 'Post-Activity', name: 'Milk with banana' },
      { order: 6, label: 'Evening Snack', name: '1 orange' },
      { order: 7, label: 'Dinner',        name: 'Rice (1.5-2 cups) + sambar + cauliflower sabzi' },
    ],
